...
class CSSMatrix extends NativeFieldWrapperClass2 {
    ...
    CSSMatrix translate([double x = 0, double y = 0, double z = 0]) native "CSSMatrix_translate_Callback";
    CSSMatrix scale([double scaleX = 0, double scaleY = 0, double scaleZ = 0]) native "CSSMatrix_scale_Callback";
    CSSMatrix rotate([double rotX = 0, double rotY = 0, double rotZ = 0]) native "CSSMatrix_rotate_Callback";
    CSSMatrix rotateAxisAngle([double x = 0, double y = 0, double z = 0, double angle = 0]) native "CSSMatrix_rotateAxisAngle_Callback";
    CSSMatrix skewX([double angle = 0]) native "CSSMatrix_skewX_Callback";
    CSSMatrix skewY([double angle = 0]) native "CSSMatrix_skewY_Callback";
