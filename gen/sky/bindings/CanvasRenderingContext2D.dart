...
abstract class CanvasRenderingContext2D extends NativeFieldWrapperClass2 {
    ...
    void fillText(String text, double x, double y, [double maxWidth = 0]) native "CanvasRenderingContext2D_fillText_Callback";
    void strokeText(String text, double x, double y, [double maxWidth = 0]) native "CanvasRenderingContext2D_strokeText_Callback";
    ...
    void setStrokeColor(String color, [double alpha = 0]) native "CanvasRenderingContext2D_setStrokeColor_Callback";
    void setFillColor(String color, [double alpha = 0]) native "CanvasRenderingContext2D_setFillColor_Callback";
    void drawImageFromRect(HTMLImageElement image, [double sx = 0, double sy = 0, double sw = 0, double sh = 0, double dx = 0, double dy = 0, double dw = 0, double dh = 0, String compositeOperation = ""]) native "CanvasRenderingContext2D_drawImageFromRect_Callback";
    void setShadow(double width, double height, double blur, [String color = "", double alpha = 0]) native "CanvasRenderingContext2D_setShadow_Callback";
