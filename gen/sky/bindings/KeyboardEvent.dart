...
abstract class KeyboardEvent extends Event {
    ...
    // Attributes
    int get key native "KeyboardEvent_key_Getter";
    String get location native "KeyboardEvent_location_Getter";
    int get charCode native "KeyboardEvent_charCode_Getter";
