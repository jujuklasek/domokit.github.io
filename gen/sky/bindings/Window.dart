...
abstract class Window extends EventTarget {
    ...
    void moveBy([double x = 0, double y = 0]) native "Window_moveBy_Callback";
    void moveTo([double x = 0, double y = 0]) native "Window_moveTo_Callback";
    void resizeBy([double x = 0, double y = 0]) native "Window_resizeBy_Callback";
    void resizeTo([double width = 0, double height = 0]) native "Window_resizeTo_Callback";
